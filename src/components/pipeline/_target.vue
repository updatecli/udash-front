                    ...
                    <v-table class="metadata-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <v-chip
                                        :color="data.DryRun ? 'warning' : 'success'"
                                        variant="outlined"
                                        size="small"
                                    >
                                ...
                                <v-expansion-panel-text>
                                    <v-row>
                                        <v-col cols="12" md="5">
                                            ...
                                            <div class="information-content bg-red-lighten-5">
                                                {{ data.Information }}
                                            </div>
                                        </v-col>
                                        ...
                                        <v-col cols="12" md="5">
                                            ...
                                            <div class="information-content bg-green-lighten-5">
                                                {{ data.NewInformation }}
                                            </div>
                                        </v-col>
                                    </v-row>
